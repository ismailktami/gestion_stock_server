...
@Entity
@Table(name = "reglementsFournisseur")
public class ReglementFournisseur extends Reglement {
	...
	public ReglementFournisseur(long idReglement, CommandeFournisseur commandeFournisseur) {
		super();
		this.idReglement = idReglement;
		this.commandeFournisseur = commandeFournisseur;
	}

	public ReglementFournisseur(@NotNull Date dateReglement, @NotNull ModeReglementEnum mode, @NotNull double montant,
	...
	/*
	 * In this child entity (of CammadeFournisseur entity) we implement the equals and
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof ReglementFournisseur))
			return false;
		ReglementFournisseur other = (ReglementFournisseur) obj;
